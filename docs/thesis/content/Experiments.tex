...
\TODO{Experiment 3 is a placeholder: the protocol above is enacted but
the pilot has not yet been run. Insert the outcome grid (variant $\times$
attempt, success/no-grasp/abort), a photograph of the wedge fixture with
its measured incline angle, and a short results paragraph once the
