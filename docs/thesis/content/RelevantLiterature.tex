...
because the object being manipulated lacks a fixed geometry:
...
manipulator to grasp. This early result showed that a physics-informed
shape prior, rather than raw image features, makes cloth state
estimation tractable. Maitin-Shepard et
...
human demonstrations. Of these, the work of Tirumala et
al.~\cite{tirumala2022singulate} is nearest in spirit to the
force-sensing emphasis of this thesis: they mounted a tactile
...
free edge. Ramisa et al.~\cite{ramisa2012wrinkled} detected and ranked
...
primitive can unfold a crumpled cloth in a few actions; here the
environment interaction resets the cloth to a flatter, more predictable
state rather than creating a pinchable feature. These strategies are
effective, but each spends additional actions and sensing before the
grasp itself, and their reliability degrades in the flat-cloth-on-surface
...
robot platforms, the Franka Hand used here among them, provide.
...
commercial end-effectors on four cloth-specific benchmarks: edge-drag
accuracy, edge-grasp resilience, crumpled-object encapsulation, and fold
...
thesis investigates. The cloth-manipulation literature treats grasp
\emph{success} as an outcome to be predicted or achieved at a fixed
operating point; it does not treat success as a function of a continuous
physical parameter space of press depth and gripper tilt whose boundary
can be mapped and compared across gripper geometries.
The evaluation in this thesis is deliberately narrower in manipulation scope
