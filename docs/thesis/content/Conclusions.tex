...
This thesis presented a controlled experimental evaluation of six gripper variants on a
...
\begin{enumerate}
  ...
  \item \emph{What is the compliant finger's response under compression?}
        ...
        blades buckle, then recovers. The finray geometry, that is,
        blade thickness, seat angle, and print instance, sets the force
        \emph{scale} but not the curve \emph{shape}, with knee peaks
        spanning 31--53\,N.
\end{enumerate}
