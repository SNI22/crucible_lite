...
\begin{enumerate}
  \item \emph{How does contact force vary with press depth for each finger
        design?} Every fin-ray variant follows a single shared
  ...
  \item \emph{How much can the gripper be tilted before the grasp becomes
        unreliable?} The fin-rays grasp reliably across every orientation
  ...
  \item \emph{What is the compliant finger's response under compression?}
        ...
        recovers --- and the fin-ray geometry (blade thickness, seat
...
The practical reading of these findings is that a finger swap alone ---
with the robot, control policy, cloth, and environment held identical ---
buys at least a $4\times$ wider press-depth tolerance than the best rigid
configuration ($\geq 10$\,mm versus 2.5\,mm on the padded jaws, and
$\geq 7\times$ versus the stock jaws), at roughly half the grip force.
...
because the fin-ray ranges are right-censored at the analysis-window end.
