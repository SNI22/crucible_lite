...
section --- exactly the scale-not-shape separation of
...
under $0.9$\,N beyond $d = +4$\,mm (raw command depth, the native axis
of the per-cell bias record) --- tracks the contact-geometry
...
of $0.5$--$1$\,mm, at or below the $0.5$\,mm cell spacing --- and it
...
near-zero from interrupted trials, saturated from safety-reflex aborts
--- inflating apparent variance. The three-way taxonomy is the
