...
deviations in press depth and gripper tilt angle, the two design degrees
of freedom most likely to be uncontrolled in real deployment?

\section{Research Questions and Contributions}

This thesis answers the following research questions through a controlled
experimental evaluation on a Franka FR3 collaborative robot. The
evaluation treats the gripper itself as the experimental variable, holding the
...
(Chapter~\ref{ch:conclusion}). The narrowing is intentional. The contact
phase is usually bundled inside end-to-end task pipelines, which is why
its mechanics have not previously been mapped as a function of gripper
design.
