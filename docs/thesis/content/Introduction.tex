...
\begin{enumerate}
  ...
  \item Is the dependence of grasp quality on tilt itself depth-dependent---and
        is the response direction-dependent (handed) about the
        finray's geometrically asymmetric axis?
  \item What is the compliant finger's mechanical response under
        compression, and is that response shared across the finray
        design family?
\end{enumerate}
